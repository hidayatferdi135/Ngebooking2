              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <form method="post" action="<?= base_url('auth/index1'); ?>" class="user login-form">
                    <div class="txtb">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?= base_url('auth/registration1') ?>">Create an Account!</a><br>
                    <a class="small" href="<?= base_url('konsumen/index') ?>">Back to home</a>
                  </div>
                </div>
              </div>
            </div>
